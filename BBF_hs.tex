...
dem Befehl \textit{\textasciitilde dirt.loadSoundFiles(''full/path/to/directory/*'')}. Mit diesem Befehl lässt sich ein Verzeichnis in Tidal integrieren. Anschließend können die Sounds mit dem Ordnernamen benutzt werden.\cite{tidcy}
...
\begin{lstlisting}
p "i1" $ sound "[bd hh]*4" #gain 0.9 # midinote 58
\end{lstlisting}
\noindent \textbf{Figur 2}\\
...
Lösung: Die hölzern klingende Rim wurde durch einen Schlag eines Bleistiftes auf eine kleine hölzerne Kiste erzeugt.
 \begin{lstlisting}
p "i1" $ stack [
sound "[bd hh]*4" #gain 1.0 #midinote 58,
cat[
sound "[Schlagzeug Schlagzeug Schlagzeug Schlagzeug Schlagzeug]"#gain 1.5 #room 0.15 #orbit 1, 
sound "[Schlagzeug Schlagzeug Schlagzeug Schlagzeug ~]"#gain 1.5 #room 0.15 #orbit 1] #gain 0.9 
]
\end{lstlisting}
\noindent \textbf{Figur 5}\\
...
Lösung:
\begin{lstlisting}
p "i1" $ cat[sound "[Schlagzeug Schlagzeug Schlagzeug Schlagzeug Schlagzeug]", sound "[Schlagzeug Schlagzeug Schlagzeug Schlagzeug ~]"] #gain 1.5
\end{lstlisting}
\noindent \textbf{Figur 6}\\
Sound: \\

\noindent \textbf{Figur 8}\\
Sound: Die letzte Figur des Schlagzeugst ist für \grqq die Ruhe vor dem Sturm\grqq zuständig, welche kurz vor dem zweiten Hauptteil zu hören ist. Dabei sieht diese Figur so aus
wie Figur 4, jedoch fehlt die Base Drum was für die \grqq Ruhe\grqq sorgt.\\
Lösung:
\begin{lstlisting}
p "i1" $ stack [
  sound "[~ hh]*4" #gain 1.3,
  cat[
    sound "[Schlagzeug Schlagzeug Schlagzeug Schlagzeug Schlagzeug]",
    sound "[Schlagzeug Schlagzeug Schlagzeug Schlagzeug ~]"] #gain 1.0
]
\end{lstlisting}
{\color{red}\textbf{TODO}} Klangbild 6-8 Raphas Meinung zu Figur 8\\
...
Art der Synthetisierung: Der Flügel wurde mittels dem SuperCollider syntetisiert. Dazu wurde die Funktion \textit{OteyPianos} benutzt, welche einen Pianoartigen klang besitzt. geschrieben. Da diese Funktion bereits im SuperCollider existiert. Der restliche Teil der geschriebenen Funktion schneidet die Höhen etwas heraus und gibt dem Klang etwas mehr Tiefe. 
\begin{lstlisting}
(
...
\begin{lstlisting}
p "i9" $ cat [
  cat [sound "[~ Klavier:3 Klavier:4 Klavier:5 ~ Klavier:3 Klavier:4 Klavier:5 ~ Klavier:3 Klavier:4 Klavier:5 ~ Klavier:3 Klavier:4 Klavier:5]", sound "[~ Klavier:3 Klavier:4 Klavier:5 ~ Klavier:3 Klavier:4 Klavier:5 ~ Klavier:3 Klavier:4 Klavier:5  ~ ~ Klavier:3]"],
  cat [sound "[~ Klavier:3 Klavier:6 Klavier:4 ~ Klavier:3 Klavier:6 Klavier:4 ~ Klavier:3 Klavier:6 Klavier:4 ~ Klavier:3 Klavier:6 Klavier:4]", sound "[~ Klavier:3 Klavier:6 Klavier:4 ~ Klavier:3 Klavier:6 Klavier:4 ~ Klavier:3 Klavier:6 Klavier:4  ~ ~ Klavier:3]"],
  cat [sound "[~ Klavier:7 Klavier:3 Klavier:8 ~ Klavier:7 Klavier:3 Klavier:8 ~ Klavier:7 Klavier:3 Klavier:8 ~ Klavier:7 Klavier:3 Klavier:8]", sound "[~ Klavier:7 Klavier:3 Klavier:8 ~ Klavier:7 Klavier:3 Klavier:8 ~ Klavier:7 Klavier:3 Klavier:8  ~ ~ Klavier:3]"],
  cat [sound "[~ Klavier:7 Klavier:3 Klavier:9 ~ Klavier:7 Klavier:3 Klavier:9 ~ Klavier:7 Klavier:3 Klavier:9 ~ Klavier:7 Klavier:3 Klavier:9]", sound "[~ Klavier:7 Klavier:3 Klavier:9 ~ Klavier:7 Klavier:3 Klavier:9 ~ Klavier:7 Klavier:3 Klavier:9  ~ ~ Klavier:7]"]
] #gain 1.0 #pan 0.35
\end{lstlisting}
\noindent \textbf{Figur 5}\\
...
Lösung:
\begin{lstlisting}
p "i9" $ cat [sound "[~ Klavier:3 Klavier:4 Klavier:5 ~ Klavier:3 Klavier:4 Klavier:5 ~ Klavier:3 Klavier:4 Klavier:5 ~ Klavier:3 Klavier:4 Klavier:5]", sound "[~ Klavier:3 Klavier:4 Klavier:5 ~ Klavier:3 Klavier:4 Klavier:5 ~ Klavier:3 Klavier:4 Klavier:5  ~ ~ Klavier:3 ~] "]
\end{lstlisting}
