...
\end{lstlisting}
\noindent \textbf{Figur 3}\\
Sound Marimba: In der dritten Figur ist die Marimba nur sehr dezent im Hintergrund zu hören. Sie dient in dieser Figur lediglich als Taktgeber.\\
Lösung:\\
\begin{lstlisting}
...
\subsubsection{Klangbild}
\textit{Abschnitt bearbeitet von: Nico Mehlhose}\\
{\color{red}\textbf{TODO}}Restlichen Figuren machen\\
