...
Bis jetzt nur alle instrumente einzeln.
Soll: Verbinden dass Performance analog Globale Struktur Abb 1 rauskommt.
Umsetzung erster Ansatz: jedes Instrument bekommt eigenen Kanal. 
Mit \verb|p "i10"| möglich.
Problem: Zu einem Zeitpunkt der Ausführung nur ein Instrument beeinflussbar. Nicht cool für wenn mehr umbricht als nur 1 instrument.

Also: Parts nachempfinden. 
Dazu einzelne Blöcke bauen.
in Blöcken spielbar mit Parametern.

Zur Ausführung im Block wenn sich mehr ändert: Mit Kommentar-Funktion siehe mute instruments \cite{tid13} Dazu alles was mut-bar sein soll in eigene Zeile. Um alles zu sehen in Atom Einstellungen - Editor - Soft Wrap aktivieren \cite{atom1}. 
...
Innerhalb des Parts an gain drehen um Lautstärke-Anstieg BD von Drums live zu reaalisien.
Einkommentieren von Tuba. 
Einkommentieren von zweitem Zeil. Daher dieser Teil 

Part 2  TODO: Update
\lstinputlisting[language=Haskell]{Figures/part2.hs}

Marimba 2 muss nicht verändert werden - eine Zeile 
Gain-Regler eingebaut um Verhältnis zwischen einzelnen Instrumenten zu regulieren.
Ebenfalls \verb|# pan| Effekte \cite{tid14} genutzt um Panning und damit hübscheren Gesamtmix...
Beschreiben Toggle Ablauf.
Piano-Figuren zur einfacheren Handhabung weiter verlängert Figuren einzelner Töne auf 8 Takte.
...
Kapitel 7 = letztes Kapitel = Kür = Gesang und wie mit in Performance handeln?
